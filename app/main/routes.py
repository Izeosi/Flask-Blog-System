...
def index():
    ...
    return render_template('index.html', title=_('HomePage'), form=form, posts=posts.items,
...
@login_required
def messages():
    current_user.last_message_read_time = datetime.now(UTC)
...
def export_posts():
    if current_user.get_task_in_progress('export_posts'):
        flash(_('An export ask is already in progress'))
    else:
